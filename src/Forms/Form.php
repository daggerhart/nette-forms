...
class Form extends Container implements Nette\HtmlStringable
{
	 ...
	 *
	 * @internal @var Nette\Http\IRequest
	 */
	public $httpRequest;
	 ...
	 * @return static
	 */
	public function setAction($url): self
	{
	...
	/**
	 * Validate submitted max post size.
	 *
	 * @internal
	 *
	 * @return void
	...
	/**
	 * Whether the form submission has errors.
	 *
	 * @return bool
	 */
